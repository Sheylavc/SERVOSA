...
class ExportarViewController: UIViewController, UIWebViewDelegate {
    ...
    func loadVistaWeb(){
        ...
        let request = NSMutableURLRequest(URL: NSURL(string: "http://www.uc-web.mobi/SERVOSA/admin/C_Grafico/getDataComportamiento")!)
